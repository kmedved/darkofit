...
| R1-3 | **B3 parallel members** — kills the 6.10× ensemble-fit optic; campaign already scoped with the §4.3 memory rules | **Authorized and frozen:** `b3-parallel-ensemble-members-v1-20260723`; private `7x2` candidate vs `1x14` sequential control, no public surface |
