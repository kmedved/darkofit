...
| 5 | **Characterization running:** ensemble-v3 public contract/private candidate complete; M6 v2 passed; current-source Tier-E characterization frozen before measurement | Contract `ensemble-v3-characterization-v1`, 2026-07-21 | Publish only bounded uncertainty/resource/prediction telemetry; no public API/export, ship, M2/M4, release, B3, Q, fresh data, or lockbox access |
